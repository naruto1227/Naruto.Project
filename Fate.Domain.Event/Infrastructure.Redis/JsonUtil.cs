...
namespace Fate.Domain.Event.Infrastructure.Redis
{
    ...
    internal static class JsonUtil
    {
        ...
        internal static string EventToJson<T>(this T eventSource) 
        {
            #region # 验证参数
        ...
        internal static object JsonToEvent(this string eventSourceJson)
        {
            #region # 验证参数
            ...
            //if (!typeof(IEventData).IsAssignableFrom(eventType))
            //{
