...
namespace Fate.Infrastructure.Configuration.Management.DB
{
    /// <summary>
    /// 张海波
    /// 2019-10-16
  ...
  : base(options)
    ...
    /// 配置信息的从库数据上下文
    /// </summary>
    public class SlaveConfigurationDbContent : DbContext
    {
        public SlaveConfigurationDbContent(DbContextOptions<SlaveConfigurationDbContent> options)
  : base(options)
        {
