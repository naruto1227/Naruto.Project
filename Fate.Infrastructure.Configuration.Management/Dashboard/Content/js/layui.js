...
!function (e) {
    ...
    var okmodules = {
        ...
        "okMock": "/fate/js/okMock",
        "okContextMenu": "/fate/js/okContextMenu",
        "okCookie": "/fate/js/okCookie",
        "okMd5": "/fate/js/okMd5",
        "okToastr": "/fate/js/okToastr",
    ...
    var modulePath = Object.assign({
        layer: "/fate/js/layer",
        laydate: "/fate/js/laydate",
        laypage: "/fate/js/laypage",
        laytpl: "/fate/js/laytpl",
        layim: "/fate/js/layim",
        layedit: "/fate/js/layedit",
        form: "/fate/js/form",
        upload: "/fate/js/upload",
        transfer: "/fate/js/transfer",
        tree: "/fate/js/tree",
        table: "/fate/js/table",
        element: "/fate/js/element",
        rate: "/fate/js/rate",
        colorpicker: "/fate/js/colorpicker",
        slider: "/fate/js/slider",
        carousel: "/fate/js/carousel",
        flow: "/fate/js/flow",
        util: "/fate/js/util",
        code: "/fate/js/code",
        jquery: "/fate/js/jquery",
        mobile: "/fate/js/mobile",
        "/fate/js/layui.all": "/fate/js/layui.all"
    }, okmodules);
