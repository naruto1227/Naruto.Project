...
!function (e, t) {
    var i, n, a = e.layui && layui.define, o = {
            ...
            if (r.path) {
                ...
                s.rel = "stylesheet", s.href = r.path + t, s.id = f, document.getElementById(f) || a.appendChild(s),
                    "function" == typeof i && function t() {
                        return ++c > 80 ? e.console && console.error("layer.css: Invalid") : void (1989 === parseInt(o.getStyle(document.getElementById(f), "width")) ? i() : setTimeout(t, 100));
                    }();
            }
        }
    }, r = {
        ...
        ready: function (e) {
            var t = "layer", i ="layer.css?v=" + r.v;
            return a ? layui.addcss(i, e, t) : o.link(i, e, t), this;
        },
        ...
        msg: function (e, t, n) {
            var a = "function" == typeof t, s = o.config.skin, f = (s ? s + " " + s + "-msg" : "") || "layui-layer-msg", c = l.anim.length - 1;
            return a && (n = t), r.open(i.extend({
                content: e,
                time: 3e3,
                shade: !1,
                ...
                return t = t || {}, (-1 === t.icon || void 0 === t.icon && !o.config.skin) && (t.skin = f + " " + (t.skin || "layui-layer-hui")),
                    t;
            }()));
        },
        load: function (e, t) {
    ...
    l.anim = ["layer-anim-00", "layer-anim-01", "layer-anim-02", "layer-anim-03", "layer-anim-04", "layer-anim-05", "layer-anim-06"],
        s.pt.config = {
            ...
            var n = this, a = n.index, r = n.config, s = r.zIndex + a, f = "object" == _typeof(r.title), c = r.maxmin && (1 === r.type || 2 === r.type), u = r.title ? '<div class="layui-layer-title" style="' + (f ? r.title[1] : "") + '">' + (f ? r.title[0] : r.title) + "</div>" : "";
            ...
            var e = this, t = e.config, a = e.index, s = t.content, f = "object" == (void 0 === s ? "undefined" : _typeof(s)), c = i("body");
            if (!t.id || !i("#" + t.id)[0]) {
                ...
                t.shift && (t.anim = t.shift), 6 == r.ie && (t.fixed = !1), t.type) {
                    ...
                    case 3:
                        delete t.title, delete t.closeBtn, -1 === t.icon && t.icon, r.closeAll("loading");
                        break;

                    case 4:
                        f || (t.content = [t.content, "body"]), t.follow = t.content[1], t.content = t.content[0] + '<i class="layui-layer-TipsG"></i>',
                            delete t.title, t.tips = "object" == _typeof(t.tips) ? t.tips : [t.tips, !0],
            ...
            var e = this, t = e.config, i = e.layero, a = [i.outerWidth(), i.outerHeight()], o = "object" == _typeof(t.offset);
            ...
            function e() {
                !1 === (a.cancel && a.cancel(t.index, n)) || r.close(t.index);
            }
            ...
            t.openLayer(), a.success && (2 == a.type ? n.find("iframe").on("load", function () {
                ...
                if (0 === e) a.yes ? a.yes(t.index, n) : a.btn1 ? a.btn1(t.index, n) : r.close(t.index); else {
                    !1 === (a["btn" + (e + 1)] && a["btn" + (e + 1)](t.index, n)) || r.close(t.index);
                }
            }), n.find("." + l[7]).on("click", e), a.shadeClose && i("#layui-layer-shade" + t.index).on("click", function () {
                r.close(t.index);
            }), n.find(".layui-layer-min").on("click", function () {
                !1 === (a.min && a.min(n)) || r.min(t.index, a);
            ...
            a.attr("minLeft"), s !== o.type[3] && s !== o.type[4] && (n || (parseFloat(t.width) <= 260 && (t.width = 260),
            ...
            i("#" + l[0] + (t || r.index)).find(l[1]).html(e);
        }, r.close = function (e) {
            var t = i("#" + l[0] + e), n = t.attr("type");
            if (t[0]) {
                var a = "layui-layer-wrap", s = function () {
                    if (n === o.type[1] && "object" === t.attr("conType")) {
                        t.children(":not(." + l[5] + ")").remove();
                        for (var r = t.find("." + a), s = 0; s < 2; s++) r.unwrap();
                        r.css("display", r.data("display")).removeClass(a);
                    } else {
                        if (n === o.type[2]) try {
                            var f = i("#" + l[4] + e)[0];
                ...
                t.data("isOutAnim") && t.addClass("layer-anim layer-anim-close"), i("#layui-layer-moves, #layui-layer-shade" + e).remove(),
                    6 == r.ie && o.reselect(), o.rescollbar(e), t.attr("minLeft") && (o.minIndex-- ,
                        o.minLeft.push(t.attr("minLeft"))), r.ie && r.ie < 10 || !t.data("isOutAnim") ? s() : setTimeout(function () {
                            s();
                        }, 200);
            }
    ...
    r.prompt = function (e, t) {
        ...
        var o = {};
        if (t = t || {}, t.photos) {
            var s = t.photos.constructor === Object, l = s ? t.photos : {}, f = l.data || [], u = l.start || 0;
            o.imgIndex = 1 + (0 | u), t.img = t.img || "img";
            var d = t.success;
            if (delete t.success, s) {
                if (0 === f.length) return r.msg("&#x6CA1;&#x6709;&#x56FE;&#x7247;");
            } else {
            ...
            o.imgprev = function (e) {
                ...
                ++o.imgIndex > f.length && (o.imgIndex = 1, t) || o.tabimg(e);
            }, o.keyup = function (e) {
                if (!o.end) {
                    var t = e.keyCode;
                ...
                if (!(f.length <= 1)) return l.start = o.imgIndex - 1, r.close(o.index), r.photos(t, !0, e);
            }, o.event = function () {
                ...
                r.close(o.loadi), o.index = r.open(i.extend({
                    type: 1,
                    ...
                    success: function (e, i) {
                        o.bigimg = e.find(".layui-layer-phimg"), o.imgsee = e.find(".layui-layer-imguide,.layui-layer-imgbar"),
                            o.event(e), t.tab && t.tab(f[u], e), "function" == typeof d && d(e);
                    },
                    end: function () {
