...
namespace Naruto.AutofacDependencyInjection
{
    public class AutofacModule : Autofac.Module
    {
        ...
        protected override void Load(ContainerBuilder builder)
        {
            ...
            //.Domain是服务所在程序集命名空间  
            Assembly assembliesDomain = Assembly.Load("Naruto.Domain");
            //appcation 服务所在的程序
            Assembly assemblyApp = Assembly.Load("Naruto.Application");
            ...
            //注入实体层
            Assembly assemblyModel = Assembly.Load("Naruto.Domain.Model");
            //注入领域事件
            Assembly assemblyEvent = Assembly.Load("Naruto.Domain.Event");
            //注入领域实体
        ...
        {
            //获取公共层的程序信息
            Assembly assemblyCommon = Assembly.Load("Naruto");
